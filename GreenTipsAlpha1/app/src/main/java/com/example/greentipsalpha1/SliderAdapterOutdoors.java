...
public class SliderAdapterOutdoors extends PagerAdapter {
    ...
    public void databaseInput(){
        Cursor tip1 = dbHelper.getTip("8", lan);
        t1 = tip1.getString(0);

        Cursor tip2 = dbHelper.getTip("9", lan);
        t2 = tip2.getString(0);

        Cursor tip3 = dbHelper.getTip("10", lan);
        t3 = tip3.getString(0);

        Cursor tip4 = dbHelper.getTip("11", lan);
        t4 = tip4.getString(0);

        Cursor tip5 = dbHelper.getTip("12", lan);
        t5 = tip5.getString(0);

        Cursor tip6 = dbHelper.getTip("13", lan);
        t6 = tip6.getString(0);

        Cursor tip7 = dbHelper.getTip("14", lan);
        t7 = tip7.getString(0);
